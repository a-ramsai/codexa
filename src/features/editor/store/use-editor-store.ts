...
export const useEditorStore = create<EditorStore>()((set,get) => ({
    ...
    openFile: (projectId,fileId,{pinned}) => {
        ...
        //case1 : opening as preview - changes
        if(!isOpen && !pinned)
        {
            const newTabs = previewTabId ? openTabs.map((id) => (id === previewTabId) ? fileId : id) : [...openTabs,fileId]
        ...
        // case 3 : file is already open , if double cliked should be prememnt
